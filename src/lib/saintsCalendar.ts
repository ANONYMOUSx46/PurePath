...
export const SAINTS_CALENDAR: Saint[] = [
  ...
  { name: "Conrad of Piacenza", date: "02-19", bio: "Little is known of Conrad's life. He seems to have been born Corrado Confalonieri, into one of the foremost families of Piacenza, in Calendasco, a fiefdom of his family, who owned the Castle of Calendasco. His date of birth is uncertain. He apparently married and aristocratic young lady, Ephrosyne, when he too was quite young. The new Roman Martyrology acknowledges his forty years as a hermit, and a life marked by prayer and acts of penance.", patronOf: ["Piacenza"], memorial: "optional" },
