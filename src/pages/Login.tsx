...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Google will redirect, so we don't need to navigate
      // The AuthContext will handle the redirect after successful auth
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen gradient-peace flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        {/* Email Login Form */}
        <form onSubmit={handleEmailLogin} className="space-y-4 animate-fade-in" style={{ animationDelay: "0.2s" }}>
